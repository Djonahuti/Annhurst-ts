...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="icon" className="overflow-hidden [&>[data-sidebar=sidebar]]:flex-row" {...props}>
      {/* Icon Sidebar */}
      <Sidebar collapsible="none" className="!w-[calc(var(--sidebar-width-icon)_+_1px)] border-r bg-gray-50 dark:bg-gray-900/90">
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
                    ...
                    <SidebarMenuButton
                      ...
                      className={`px-2.5 transition-colors ${
                        activeItem?.title === item.title
                          ...
                          : 'text-gray-700 dark:text-gray-200 hover:bg-primary hover:text-white'
                      }`}
                    >
                      <item.icon />
      ...
      {/* Main Sidebar */}
      <Sidebar collapsible="none" className="hidden flex-1 md:flex flex-col bg-gray-50 dark:bg-gray-900/90">
